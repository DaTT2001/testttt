  ...
  return (
    <div className={style.homeContainer}>
      ...
      <div className={style.landingBanner}>
        <img
          src="https://landing-page-prod-hn-ss-bfcplatform.cdn.vccloud.vn/landing-page-prod/cloud-server_tlokvkdx.png"
          width={400}
        />
        <span>
          <h3>Cloud Server là gì ?</h3>
          <p>
            Cloud Server là một dịch vụ lưu trữ và quản lý máy chủ trên nền tảng
            đám mây (Cloud Computing). Thay vì phải sử dụng máy chủ vật lý,
            doanh nghiệp có thể sử dụng dịch vụ Cloud Server để lưu trữ, quản lý
            và truy cập dữ liệu của mình thông qua internet.
          </p>
        </span>
      </div>
      <Container>
